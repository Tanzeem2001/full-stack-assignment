...
// function TransactionsTable({ onFetchTransactions }) {
...
//         {/* Use transactions to dynamically populate rows */}
//         <tbody>
...
function TransactionsTable({ onFetchTransactions, selectedMonth: propSelectedMonth }) {
  ...
  const fetchTransactions = () => {
    ...
    fetch(`YOUR_TRANSACTIONS_API_ENDPOINT?month=${selectedMonth}&start=${startIndex}&limit=${itemsPerPage}`)
